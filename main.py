...
# Load images
bg_img = pygame.image.load('assets/img/bg_img/bg1.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height))
restart_img = pygame.image.load('assets/img/button_img/restart_btn.png')

# Load sounds
pygame.mixer.music.load('assets/audios/music.mp3')
pygame.mixer.music.set_volume(0.35)
pygame.mixer.music.play(-1, 0.0, 5000)
coin_fx = pygame.mixer.Sound('assets/audios/coin.wav')
coin_fx.set_volume(0.5)
jump_fx = pygame.mixer.Sound('assets/audios/jump.wav')
jump_fx.set_volume(0.5)
game_over_fx = pygame.mixer.Sound('assets/audios/game_over.wav')
game_over_fx.set_volume(0.5)

img_list = []
for x in range(TILE_TYPES):
    img = pygame.image.load(f'assets/img/tiles/{x}.png')
