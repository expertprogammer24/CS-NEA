...
class Player:
    ...
    def reset(self, x, y):
        ...
        run_sprite_sheet = pygame.image.load('assets/img/character/run2.png')
        frame_width = 32
        frame_height = 32
        scale_width = 49
        scale_height = 53
        ...
        idle_sprite_sheet = pygame.image.load('assets/img/character/idle.png')
        for num in range(11):
        ...
        double_jump_sprite_sheet = pygame.image.load('assets/img/character/double_jump.png')
        for num in range(6):
