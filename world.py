...
class World:
    def __init__(self, data, tile_size, blob_group, platform_group, lava_group, coin_group, exit_group, enemy_group):
        ...
        self.images = {
            'dirt1': pygame.transform.scale(pygame.image.load('assets/img/tiles/1.png'), (tile_size, tile_size)),
            'dirt2': pygame.transform.scale(pygame.image.load('assets/img/tiles/2.png'), (tile_size, tile_size)),
            'dirt3': pygame.transform.scale(pygame.image.load('assets/img/tiles/3.png'), (tile_size, tile_size)),
            'dirt4': pygame.transform.scale(pygame.image.load('assets/img/tiles/4.png'), (tile_size, tile_size)),
            'dirt5': pygame.transform.scale(pygame.image.load('assets/img/tiles/5.png'), (tile_size, tile_size)),
            'dirt6': pygame.transform.scale(pygame.image.load('assets/img/tiles/6.png'), (tile_size, tile_size)),
            'dirt7': pygame.transform.scale(pygame.image.load('assets/img/tiles/7.png'), (tile_size, tile_size)),
            'grass': pygame.transform.scale(pygame.image.load('assets/img/tiles/13.png'), (tile_size, tile_size))
        }
